...
PythonCodeGraph 基于 Python AST 对目标项目进行静态解析，提取模块、类、函数、方法、常量以及外部依赖关系，并以可交互图谱方式呈现。
...
- 标准模式支持：单击关系高亮、双击聚焦子图、返回全图
- 蓝图模式支持：引脚级连线映射、关系高亮、双击聚焦子图、返回全图
- 支持侧边栏折叠与类型简写显示，提升大型图谱可读性
